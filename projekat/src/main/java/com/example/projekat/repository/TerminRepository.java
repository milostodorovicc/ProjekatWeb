...
public interface TerminRepository extends JpaRepository<Termin, Long> {
    ...
    List<Termin> findByTreningNazivContainsAndTreningOpisContainsAndTreningTipContainsAndDatumGreaterThanEqualAndCenaLessThanEqual(String naziv,String opis, String tip,LocalDateTime vremeTreninga, Double cena);
